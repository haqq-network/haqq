...
replace (
	...
	// need this replace to pick up the store changes (Copy func) in Haqq cosmos-sdk fork
	...
	github.com/cosmos/cosmos-sdk => github.com/haqq-network/cosmos-sdk v0.50.14-haqq
	// use Evmos geth fork
