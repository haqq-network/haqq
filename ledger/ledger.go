...
import (
	...
	"github.com/haqq-network/haqq/ledger/accounts"
	"github.com/haqq-network/haqq/ledger/usbwallet"
)
...
func (e EvmosSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte, signMode byte) ([]byte, error) {
