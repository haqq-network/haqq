...
const (
	// AttoIslm defines the default coin denomination used in Haqq in:
	//
	// - Staking parameters: denomination used as stake in the dPoS chain
	// - Mint parameters: denomination minted due to fee distribution rewards
	// - Governance parameters: denomination used for spam prevention in proposal deposits
	// - Crisis parameters: constant fee denomination used for spam prevention to check broken invariant
	// - EVM parameters: denomination used for running EVM state transitions in Haqq.
	AttoIslm string = "aISLM"

	// BaseDenomUnit defines the base denomination unit for Haqq.
...
func NewIslmCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoIslm, amount)
}
...
func NewIslmDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoIslm, amount)
}
...
func NewIslmCoinInt64(amount int64) sdk.Coin {
	return sdk.NewInt64Coin(AttoIslm, amount)
}
