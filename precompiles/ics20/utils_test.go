...
import (
	...
	haqqibc "github.com/haqq-network/haqq/ibc/testing"
...
func (s *PrecompileTestSuite) setupIBCTest() {
	...
	s.transferPath = haqqibc.NewTransferPath(s.chainA, s.chainB) // clientID, connectionID, channelID empty
	haqqibc.SetupPath(s.coordinator, s.transferPath)             // clientID, connectionID, channelID filled
