...
"$(./haqqd keys show $KEY -a --home $DATA_DIR --keyring-backend test)" 1000000000000000000aISLM \
--home $DATA_DIR --keyring-backend test
echo "prepare genesis: Sign genesis transaction"
./haqqd gentx $KEY 1000000000000000000aISLM --keyring-backend test --home $DATA_DIR --keyring-backend test --chain-id $CHAINID
