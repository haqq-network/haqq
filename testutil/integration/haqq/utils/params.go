...
// UpdateCoinomicsParams helper function to update the coinomics module parameters
// It submits an update params proposal, votes for it, and waits till it passes
func UpdateCoinomicsParams(input UpdateParamsInput) error {
	return updateModuleParams[coinomicstypes.Params](input, coinomicstypes.ModuleName)
}
...
func createProposalMsg(params interface{}, name string) sdk.Msg {
	...
	case coinomicstypes.ModuleName:
		// return &coinomicstypes.MsgUpdateParams{Authority: authority, Params: params.(coinomicstypes.Params)}
		// TODO implement
		return nil
