...
```log
ok  	github.com/haqq-network/haqq/tests/e2e	174.137s.
```
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/haqq-network/haqq/cmd/haqqd/root.go:243 +0x2ca
        github.com/haqq-network/haqq/server.startInProcess(_, {{0x0, 0x0, 0x0},...
            github.com/haqq-network/haqq/server/start.go:304 +0x9c5
        github.com/haqq-network/haqq/server.StartCmd.func2(0xc001620600?, {0xc0...
            github.com/haqq-network/haqq/server/start.go:123 +0x1ec
        ...
        main.main()
            github.com/haqq-network/haqq/cmd/haqqd/main.go:20 +0x45
