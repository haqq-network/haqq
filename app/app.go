...
import (
	...
	v1201 "github.com/haqq-network/haqq/app/upgrades/v1.2.0.1"
)
...
func (app *Haqq) setupUpgradeHandlers() {
	...
	// v1.2.0.1 update handler (IBC Enable)
	app.UpgradeKeeper.SetUpgradeHandler(
		v1201.UpgradeName,
		v1201.CreateUpgradeHandler(
			app.mm,
			app.configurator,
		),
	)
