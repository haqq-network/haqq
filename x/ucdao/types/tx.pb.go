...
type MsgConvertToEthiqResponse struct {
	BurntCoin github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,1,opt,name=burnt_coin,json=burntCoin,proto3,casttype=github.com/cosmos/cosmos-sdk/types.Coin" json:"burnt_coin"`
...
func (m *MsgConvertToEthiqResponse) GetBurntCoin() github_com_cosmos_cosmos_sdk_types.Coin {
	if m != nil {
		return m.BurntCoin
	}
...
func (m *MsgConvertToEthiqResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func (m *MsgConvertToEthiqResponse) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
var fileDescriptor_0b4b97a33ac1ff40 = []byte{
	...
	,
}
...
func (m *MsgConvertToEthiqResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.BurntCoin.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgConvertToEthiqResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BurntCoin", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BurntCoin.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
