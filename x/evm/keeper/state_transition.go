...
import (
	...
	evmcore "github.com/haqq-network/haqq/x/evm/core/core"
...
func (k *Keeper) ApplyMessageWithConfig(
	...
	gasLimit := math.LegacyNewDecFromInt(math.NewIntFromUint64(msg.Gas()))
	...
	gasUsed := math.LegacyMaxDec(minimumGasUsed, math.LegacyNewDecFromInt(math.NewIntFromUint64(temporaryGasUsed))).TruncateInt().Uint64()
