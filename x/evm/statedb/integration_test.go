...
import (
	...
	testcontracts "github.com/haqq-network/haqq/precompiles/testutil/contracts"
...
var _ = Describe("testing the flash loan exploit", Ordered, func() {
	...
	BeforeAll(func() {
		...
		var err error
		stakingPrecompile, err = stakingprecompile.NewPrecompile(network.App.StakingKeeper, network.App.DistrKeeper, network.App.AuthzKeeper)
