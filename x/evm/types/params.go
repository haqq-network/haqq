...
var (
	// DefaultEVMDenom defines the default EVM denomination on Haqq Network
	...
	DefaultStaticPrecompiles = []string{
		...
		LiquidPrecompileAddress, // Liquid precompile
	}
	...
	DefaultEVMChannels              = []string(nil) // []string{} causes an error in tests due to unmarshalling of an empty array into nil
