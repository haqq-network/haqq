...
var (
	...
	ErrUnlockCoins          = sdkerrors.Register(ModuleName, 9, "failed to unlock coins on vesting account")
	ErrBurnCoins            = sdkerrors.Register(ModuleName, 10, "failed to burn coins")
	ErrMintCoins            = sdkerrors.Register(ModuleName, 11, "failed to mint coins")
)
