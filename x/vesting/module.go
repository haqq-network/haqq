...
import (
	...
	"github.com/haqq-network/haqq/x/vesting/client/cli"
	"github.com/haqq-network/haqq/x/vesting/keeper"
...
// GetQueryCmd returns the module's root query command for vesting module.
