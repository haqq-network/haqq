...
func init() {
	proto.RegisterType((*EventCreateClawbackVestingAccount)(nil), "haqq.vesting.v1.EventCreateClawbackVestingAccount")
	proto.RegisterType((*EventClawback)(nil), "haqq.vesting.v1.EventClawback")
	proto.RegisterType((*EventUpdateVestingFunder)(nil), "haqq.vesting.v1.EventUpdateVestingFunder")
}

func init() { proto.RegisterFile("haqq/vesting/v1/events.proto", fileDescriptor_7b55c9df74a10f44) }
