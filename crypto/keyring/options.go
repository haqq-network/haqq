...
import (
	...
	"github.com/haqq-network/haqq/wallets/ledger"
)

// AppName defines the Ledger app used for signing. Haqq uses the Ethereum app
const AppName = "Ethereum"

var (
	// SupportedAlgorithms defines the list of signing algorithms used on Haqq:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Haqq for the Ledger device:
	...
	// LedgerDerivation defines the Haqq Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.HaqqLedgerDerivation()
