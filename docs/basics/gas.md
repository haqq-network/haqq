...
+++ https://github.com/haqq-network/haqq/blob/master/x/evm/keeper/state_transition.go#L188
...
+++ https://github.com/haqq-network/haqq/blob/master/x/evm/keeper/grpc_query.go#L100
