...
```
In this example, my validator has the IP address of 123.456.32.123 and we will be using port 688 to feed the validator key to the validator. We will also be using chain_id `haqq_54211-2` for Haqq Mainnet, but if you are doing this on the testnet be sure to use `haqq_54211-2` instead:
