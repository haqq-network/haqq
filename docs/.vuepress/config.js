module.exports = {
  ...
  themeConfig: {
    ...
    project: {
      ...
      testnet_denom: 'ISLM',
      testnet_ticker: 'ISLM',
      rpc_ws_url: 'https://rpc-ws.eth.haqq.network',
      rpc_eth_url: 'https://rpc.eth.haqq.network',
      rpc_tm_url: 'https://rpc.tm.haqq.network',
      grpc_cosmos_url: 'https://grpc.cosmos.haqq.network',
      rest_api_url: 'https://rest.cosmos.haqq.network',
      rpc_url_local: 'http://localhost:8545/',
      chain_id: '11235',
      testnet_chain_id: '53211',
